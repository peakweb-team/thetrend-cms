...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    callout: Schema.Attribute.Boolean &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiDirectoryCategoryDirectoryCategory
  ...
  info: {
    description: 'Organize directory entries into categories';
    displayName: 'Directory Category';
    pluralName: 'directory-categories';
    singularName: 'directory-category';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiDirectoryDirectory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Create directory listings with links and resources';
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Site-wide settings, branding, and default SEO configuration';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
...
export interface ApiGlossaryCategoryGlossaryCategory
  extends Struct.CollectionTypeSchema {
  collectionName: 'glossary_categories';
  info: {
    description: 'Organize glossary entries into categories';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::glossary-category.glossary-category'
    >;
    name: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
...
export interface ApiGlossaryGlossary extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Define terms, acronyms, and concepts';
...
export interface ApiLegalPageLegalPage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Legal pages such as terms of service, privacy policy, etc.';
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::glossary-category.glossary-category': ApiGlossaryCategoryGlossaryCategory;
