...
export function generateMetadata(
  content: { title: string; description?: string; seo?: SeoData; cover?: { url: string } },
  ...
  const description = seo.metaDescription || defaultSeo.metaDescription || content.description;
  const image = seo.metaImage?.url || defaultSeo.metaImage?.url || content.cover?.url;
